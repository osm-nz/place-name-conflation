//
// copy pasted from the LINZ Address Import repo, see unit tests in that repo.
// https://github.com/osm-nz/linz-address-import/blob/main/src/extraLayers/linzTopo/geoOperations/simplify.ts
//

type Coord = [x: number, y: number] | [x: number, y: number, z: number];
...
function simplifyDPStep(
  ...
  for (let tempIndex = first + 1; tempIndex < last; tempIndex += 1) {
